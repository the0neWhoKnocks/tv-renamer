  ...
  return `
    ...
    <body>
      <svg style="position:absolute" width="0" height="0">
        ...
        <symbol id="ui-icon_tvdb" viewBox="0 0 188 105" xmlns="http://www.w3.org/2000/svg">
          <path transform="translate(-865.4 -487.75)" id="a" fill="#1C7E3E" d="M971.15 532q-3.9458984 4.9998047-3.95 12.25.0292969 5.9917969 3.85 11.05l.1-23.3m-95.9-44.25q-4.55-.2-7.5 3.05-2.85 3.05-2.25 6.95L875 585q.4 4.2 3.9 6.45 3.75 2.45 9.85 1.55L963 582q3.65-.55 5.95-3.4 2.2-2.7 2.05-5.85v-6.45q-1.3384766-.9011719-2.65-2.1-1.4091797-1.2904297-2.7-2.9-6.4822266-7.719336-6.45-17.05-.0042969-10.8341797 6.35-18.1l.05-.05q1.5263672-1.6490234 3.15-2.9h-.05q1.2152344-.953711 2.5-1.7l.05-13q.2-3.55-2.3-6.05-2.65-2.75-7.7-3.45l-86-11.25m8.75 45v-8.25h7.25v-15.25h11v15.5h23l10.5 29.25L948 525h11.25l-17.75 40.5h-11.75l-13.25-32.75h-14.45V553q.6 4.3 4.7 4.35h6.05V566l-10.3-.25q-11-1.8-11.45-11.75v-21.25H884z"/>
          <path transform="translate(-865.4 -487.75)" id="b" fill="#FFF" d="M968.6 528.8q-5.4 6.2-5.4 15.45 0 7.95 5.55 14.55 5.55 6.7 12.45 6.7h24.75v-57.25q-.3-.15-6.3-.1-3 .05-5.95.1V523h-12.75q-7.1-.2-12.35 5.8m6.95 15.45q-.05-4.85 2.35-8.05 2.5-3.35 6.55-3.4l9-.05v22.75h-8.35q-3.7 0-6.45-2.9-3.05-3.25-3.1-8.35m47.95-36q-2.95-.05-5.95-.1-6-.05-6.3.1v57.25H1036q6.9 0 12.45-6.7 5.55-6.6 5.55-14.55 0-9.25-5.4-15.45-5.25-6-12.35-5.8h-12.75v-14.75m9.25 24.55q4.05.05 6.55 3.4 2.4 3.2 2.35 8.05-.05 5.1-3.1 8.35-2.75 2.9-6.45 2.9h-8.35v-22.75l9 .05m-74-13.05q1.75-1.75 1.75-4.25t-1.75-4.25q-1.75-1.75-4.25-1.75t-4.25 1.75q-1.75 1.75-1.75 4.25t1.75 4.25q1.75 1.75 4.25 1.75t4.25-1.75z"/>
        </symbol>
      </svg>
